...
def isaac_main(
    ...
    :param object_id: str (only for OakInk to get the specific object urdf)
...
if __name__ == '__main__':
    ...
    assert ((args.object_id is not None) or (args.dataset_name == "cmap")), "Object name is required for OakInk dataset!"
