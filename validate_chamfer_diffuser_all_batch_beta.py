...
def main(cfg):
    ...
    result_path = "/data/zwq/code/Scene-Diffuser/outputs/2025-04-13_17-25-11_oakink_rotmat_all_robot_pn2_object_pn2_three_split_ss_shadow/eval/final_validate_data/2025-04-14_20-47-02/res_diffuser_k3.pkl"
        ...
        for k in range(k_sample):
            try:
                ...
                for sample_idx in range(batch_size):
                    ...
                    sample_data = {key: batch_data[key][sample_idx] if isinstance(batch_data[key], np.ndarray) and batch_data[key].shape[0] == batch_size 
                                else batch_data[key] for key in batch_data if key != 'ddpm_qpos'}
                    
                    sample_data['predict_q'] = batch_data['ddpm_qpos'][sample_idx][k]  # Only keep the k-th prediction
