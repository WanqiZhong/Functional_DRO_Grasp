...
from model.network import create_network_larger_transformer_clip_add_dgcnn_acc_cvae
...
@hydra.main(version_base="1.2", config_path="configs", config_name="train_clip_512_add_dgcnn_acc_cave")
def main(cfg):
    print("******************************** [Config] ********************************")
    ...
    network = create_network_larger_transformer_clip_add_dgcnn_acc_cvae(cfg.model, mode='train')
