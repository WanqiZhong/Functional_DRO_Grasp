...
from model.network import create_network_mix_transformer_openai
from model.module import TrainingModule


@hydra.main(version_base="1.2", config_path="configs", config_name="train_mix_retarget_language_mix_transformer_openad")
def main(cfg):
    print("******************************** [Config] ********************************")
    ...
    network = create_network_mix_transformer_openai(cfg.model, mode='train')
