...
GRASP_DATA_PATH = "/data/zwq/code/DexGraspBench/output/debug_shadow/graspdata/binoculars_o42103/scale100_pose000/0.npy"
DRO_OBJECT_PATH = "/data/zwq/code/DRO_Grasp/data/data_urdf/object/oakink/binoculars/coacd_o42103.obj"
HAND_OBJECT_PATH = "/data/zwq/code/DexGraspBench/output/debug_shadow/vis_obj/binoculars_o42103/scale100_pose000/0_grasp_0.obj"
OBJECT_PATH = "/data/zwq/code/DexGraspBench/output/debug_shadow/vis_obj/binoculars_o42103/scale100_pose000/0_obj.obj"
...
def main():
    ...
    # Setup scene
    visualize_scene(server, hand, reorder_q, reorder_bodex_q, robot_name, obj_scale, obj_pose)
    # Keep the server running
    while True:
        time.sleep(1)

def visualize_scene(server, hand: HandModel, q, bodex_q, robot_name, obj_scale=1.0, obj_pose=None):
