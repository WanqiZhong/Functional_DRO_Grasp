...
GRASP_DATA_PATH = "/data/zwq/code/DexGraspBench/output/diffusion_shadow/evaluation/teapot/o13110/0.npy"
DRO_OBJECT_PATH = "/data/zwq/code/DRO_Grasp/data/data_urdf/object/oakink/teapot/coacd_o13110.obj"
HAND_OBJECT_PATH = "/data/zwq/code/DexGraspBench/output/diffusion_shadow/vis_obj/teapot/o13110/0_grasp_0.obj"
OBJECT_PATH = "/data/zwq/code/DexGraspBench/output/diffusion_shadow/vis_obj/teapot/o13110/0_obj.obj"
# DRO_PATH = "/data/zwq/code/Scene-Diffuser/outputs/2025-02-16_09-58-23_oakink_rotmat_all_custom_robot_pn2_object_pn2_new_spilt_short_sentence/eval/final_validate_data/2025-03-10_16-10-39-teapot/res_diffuser_only_predict_q.pkl"
DRO_PATH = "/data/zwq/code/DRO_Grasp/output/model_origin/res_diffuser_dro_predict_q.pkl"
...
def main():
    ...
    if robot_name == "shadowhand":
        ...
        oakink_q = pickle.load(open(DRO_PATH, 'rb'))['results'][0]['predict_q'][0]
