...
from model.network import create_network_larger_transformer_openai_openad_dgcnn
from model.module import TrainingModule


@hydra.main(version_base="1.2", config_path="configs", config_name="train_mix_retarget_language_larger_transformer_openai_256_openaddgcnn")
def main(cfg):
    print("******************************** [Config] ********************************")
    ...
    network = create_network_larger_transformer_openai_openad_dgcnn(cfg.model, mode='train')
