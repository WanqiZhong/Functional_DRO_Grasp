...
@hydra.main(version_base="1.2", config_path="configs", config_name="train_mix_retarget_language_larger_transformer_clip_512_dgcnn")
def main(cfg):
    print("******************************** [Config] ********************************")
    ...
    network = create_network_larger_transformer_clip_dgcnn(cfg.model, mode='train')
