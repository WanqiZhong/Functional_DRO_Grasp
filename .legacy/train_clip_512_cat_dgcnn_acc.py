...
from model.network import create_network_larger_transformer_clip_cat_dgcnn_acc
...
@hydra.main(version_base="1.2", config_path="configs", config_name="train_clip_512_cat_dgcnn_acc")
def main(cfg):
    print("******************************** [Config] ********************************")
    ...
    network = create_network_larger_transformer_clip_cat_dgcnn_acc(cfg.model, mode='train')
