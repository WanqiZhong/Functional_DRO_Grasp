...
from model.network import create_network_openai_cat_dgcnn
from model.module import TrainingModule


@hydra.main(version_base="1.2", config_path="configs", config_name="train_openai_256_cat_dgcnn")
def main(cfg):
    print("******************************** [Config] ********************************")
    ...
    network = create_network_openai_cat_dgcnn(cfg.model, mode='train')
