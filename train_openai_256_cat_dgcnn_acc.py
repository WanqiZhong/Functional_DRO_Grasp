...
from model.network import create_network_openai_cat_dgcnn_acc
...
@hydra.main(version_base="1.2", config_path="configs", config_name="train_openai_256_cat_dgcnn_acc")
def main(cfg):
    print("******************************** [Config] ********************************")
    ...
    network = create_network_openai_cat_dgcnn_acc(cfg.model, mode='train')
