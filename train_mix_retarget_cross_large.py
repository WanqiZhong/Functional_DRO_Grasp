...
from model.network import create_network, create_network_large
from model.module import TrainingModule


@hydra.main(version_base="1.2", config_path="configs", config_name="train_mix_retarget_cross_large")
def main(cfg):
    print("******************************** [Config] ********************************")
    ...
    network = create_network_large(cfg.model, mode='train')
